...
def check_branch_status(task_group_config):
    ...
    for parameter_key,parameter_script_location in parameters.items():
        ...
        parameter_value = execute_sql(oracle_tdw_connection, parameter_query)
    ...
    condition_result = execute_sql(oracle_tdw_connection, condition_query)
    ...
    if isinstance(compared_value, str) and compared_value.endswith('.sql'):
        ...
        compared_value = execute_sql(oracle_tdw_connection, compared_parameter_script)
